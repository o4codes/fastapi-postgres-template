...
class UserRepository(BaseRepository[User]):
    ...
    async def get_by_id_with_relations(self, id: str, include_deleted: bool = False) -> Optional[User]:
    ...
    async def add_direct_permission(self, user: User, permission_id: str) -> UserPermission:
    ...
    async def get_users_by_role(self, role_id: str, include_deleted: bool = False) -> List[User]:
